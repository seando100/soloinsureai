      ...
      <div className="max-w-5xl mx-auto px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-lg sm:text-xl text-slate-600 max-w-3xl mx-auto">
            Have questions about SoloInsureAI? We'd love to hear from you. Send us a message and we'll respond as soon as possible.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <div className="space-y-6">
            <div className="rounded-xl border border-slate-200 bg-white p-6">
              ...
              <a href="mailto:sean@solosolutionsai.com" className="text-sm text-[#F59E0B] hover:underline font-medium">
          ...
          <div className="rounded-xl border border-slate-200 bg-white p-6">
            ...
            {submitted ? (
              <div className="text-center py-12">
                ...
                <p className="text-sm text-slate-600">We'll notify you when SoloInsureAI launches.</p>
              </div>
            ) : (
              <form
              ...
              >
                ...
                <div>
                  <label htmlFor="practice" className="text-sm font-medium mb-2 block">Lines of Business</label>
                  <input
                    id="practice"
                    name="practice"
                    type="text"
                ...
                <div>
                  ...
                  <textarea
                    ...
                    required
                    rows={4}
                    placeholder="Tell us more about your question or how you'd like to use SoloInsureAI..."
                    className="w-full rounded-md border border-slate-300 px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-[#F59E0B]/50 focus:border-[#F59E0B] resize-none"
                  />
                </div>
