    ...
    <section className="py-24">
      <div className="max-w-5xl mx-auto px-6 lg:px-8">
        <div className="text-center mb-16">
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold tracking-tight mb-4">{t('faq.hero.title')}</h1>
          <p className="text-lg sm:text-xl text-muted-foreground max-w-3xl mx-auto">{t('faq.hero.subtitle')}</p>
        </div>
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <Accordion type="single" collapsible className="w-full">
            ...
            <AccordionItem value="support-2">
              ...
              <AccordionContent>
                <Trans
                  i18nKey="faq.support2.a"
                  components={{
                    strong: <strong />,
                    contact: <Link to="/contact" className="underline text-[#0F2745]" />,
                  }}
                />
              </AccordionContent>
            </AccordionItem>
        ...
        <div className="text-center mt-20">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="/#waitlist" className="bg-[#0F2745] text-white px-6 py-3 rounded-md text-sm font-medium hover:bg-[#0C2038] transition inline-flex items-center justify-center">{t('faq.cta.waitlist')}</a>
            <Link to="/contact" className="text-sm font-medium text-gray-700 hover:text-black transition-colors inline-flex items-center justify-center px-6 py-3">{t('faq.cta.contact')}</Link>
          </div>
        </div>
      </div>
    </section>
